...
ROUND(ug01_acumulador_energia/1000,2) AS `acumulador energia`,
ug01_temp_mancal_ger AS `temp mancal gerador`,
ug01_temp_mancal_comb_ger AS `temp mancal comb gerador`,
ug01_temp_mancal_tub AS `temp mancal turbina` FROM cgh_maria_luz WHERE data_hora >= '${1}' AND data_hora <= '${2}' ORDER BY data_hora DESC;
