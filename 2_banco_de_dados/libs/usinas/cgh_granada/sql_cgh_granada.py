...
#-------------------------------------------------------------------------------
senha_anydesk = 'Gra654123@'
ugs = int(2)
table_usina = 'cgh_granada'
...
tags_UG01 = {
    ...
    'ug01_corrente_fase_A':['UG01_750_862','I_FaseA','13605','UG-01 Corrente Fase A','Signed','INT'],
    'ug01_corrente_fase_B':['UG01_750_862','I_FaseB','13606','UG-01 Corrente Fase B','Signed','INT'],
    'ug01_corrente_fase_C':['UG01_750_862','I_FaseC','13607','UG-01 Corrente Fase C','Signed','INT'],
    'ug01_tensao_excitacao':['UG01_750_862','ExcitacaoTensao','13597','UG-01 Tensao Excitacao','Unsigned','INT'],
    'ug01_corrente_excitacao':['UG01_750_862','ExcitacaoCorrente','13598','UG-01 Corren. Excitação','Unsigned','INT'],
    'ug01_frequencia':['UG01_750_862','FHz_INST','13613','UG-01 Frequência','Signed','INT'],
    'ug01_potencia_ativa':['UG01_750_862','P_INST','13609','UG-01 Potência Ativa','Unsigned','BIGINT'],
    'ug01_potencia_reativa':['UG01_750_862','Q_INST','13610','UG-01 Potência Reativa','Unsigned','BIGINT'],
    'ug01_potencia_aparente':['UG01_750_862','S_INST','13611','UG-01 Potência Aparente','Unsigned','BIGINT'],
    'ug01_fp':['UG01_750_862','PF_INST','13612','UG-01 Fator de Potência','Signed','INT'],
    'ug01_distribuidor':['UG01_750_862','PosicaoDistribuidor','13593','UG-01 Distribuidor','Float','INT'],
    'ug01_velocidade':['UG01_750_862','Turbina_Velocidade','13595','UG-01 Velocidade RPM','Float','INT'],
    'ug01_horimetro_eletrico':['UG01_750_862','Horimetro_Eletrico','12894','UG-01 Horimetro','Float','FLOAT'],
    'ug01_temp_enrol_A':['UG01_750_862','MED_750450_AR2_RTD3','13574','UG-01 Temp. Fase A','Float','INT'],
    'ug01_temp_enrol_B':['UG01_750_862','MED_750450_AR1_RTD2','13574','UG-01 Temp. Fase A','Float','INT'],
    'ug01_temp_enrol_C':['UG01_750_862','MED_750450_AR1_RTD3','13574','UG-01 Temp. Fase A','Float','INT'],
    'ug01_temp_nucl_estator':['UG01_750_862','MED_750450_AR1_RTD4','13574','UG-01 Temp. Fase A','Float','INT'],
    'ug01_temp_cs':['UG01_750_862','MED_750450_AR3_RTD4','13574','UG-01 Temp. Fase A','Float','INT'],
    'ug01_temp_manc_LNA_Ger':['UG01_750_862','MED_750450_AR2_RTD1','13574','UG-01 Temp. Fase A','Float','INT'],
    'ug01_temp_manc_esc_LA':['UG01_750_862','MED_750450_AR2_RTD2','13574','UG-01 Temp. Fase A','Float','INT'],
    'ug01_temp_Gax_LNA_Ger':['UG01_750_862','MED_750450_AR3_RTD1','13574','UG-01 Temp. Fase A','Float','INT'],
    'ug01_temp_manc_LNA':['UG01_750_862','MED_750450_AR3_RTD2','13574','UG-01 Temp. Fase A','Float','INT'],
    'ug01_temp_Gax_LNA_Turb':['UG01_750_862','MED_750450_AR3_RTD3','13574','UG-01 Temp. Fase A','Float','INT'],
}
...
for tags in tags_list:
    for key, value in tags.items():
        ...
        resp = buscar_tags(value[1],'tags_granada.csv')
...
'''
Acrescentar os alarmes no supervisorio da granada
'''
