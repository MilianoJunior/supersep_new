...
tags_UG01 = {
    'ug01_acumulador_energia':['UG01_750_862','EnergiaFornecidakWh','13569','Nível Água','Signed','INT'],
    ...
    'ug01_pos_distribuidor':['UG01_750_862','Turbina_PosicaoDistribuidor','13612','UG-01 Fator de Potência','Signed','INT'],
    ...
    'ug01_temp_mancal_axialC':['UG01_750_862','AR1_RTD1','13574','UG-01 Temp. Fase A','Signed','INT'],
    'ug01_temp_mancal_radialC':['UG01_750_862','AR1_RTD2','13574','UG-01 Temp. Fase A','Signed','INT'],
    'ug01_temp_mancal_RoG':['UG01_750_862','AR1_RTD3','13574','UG-01 Temp. Fase A','Signed','INT'],
    'ug01_temp_oleo_UHCC':['UG01_750_862','AR1_RTD4','13574','UG-01 Temp. Fase A','Signed','INT'],
    'ug01_pressao_oleo':['UG01_750_862','UHRV_PressaoOleo','13574','UG-01 Temp. Fase A','Signed','INT'],
}
# UG01_Leitura.UHRV_PressaoOleo
macro_offline = f'''
sub int persistir()
//---------------------------------------------------
...
for tags in tags_list:
    for key, value in tags.items():
        ...
        resp = buscar_tags(value[1],'tags_ponte_serrada.csv')
