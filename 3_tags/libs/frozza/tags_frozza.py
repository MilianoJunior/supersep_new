status = '''
		...
		(*01x20309*) Operacao_PresencaTensaoSA							AT%MX501.4:  BOOL;
		...
		(*01x20535*) Turbina_BorboletaSeguranca								AT%MX515.6:  BOOL;
		...
		(*01x20545*) RegV_Habilitado											AT%MX516.0: BOOL;
		...
		(*01x20566*) RegV_SobreVel_Mecanica								AT%MX517.5: BOOL;
		...
		(*01x20650*) Disj52L_MolaCarregada									AT%MX522.9:  BOOL;
		...
		(*01x20657*) PCP_DisjQCCV1_Status									AT%MX523.0:  BOOL;
		...
		(*01x20663*) PCP_DisjQCCV2_Status									AT%MX523.6:  BOOL;
...
leituras = '''
	...
	(*Turbinna*)
	(*04x13301*) Turbina_Pressao_JusanteBorboleta							AT%MW1012: INT;
	(*04x13302*) Turbina_Pressao_MontanteBorboleta						AT%MW1013: INT;
	(*04x13303*) Turbina_PosicaoDistribuidor									AT%MW1014: REAL;
	(*04x13305*) Turbina_PosicaoRotor											AT%MW1016: REAL;
	(*04x13307*) Turbina_Velocidade											AT%MW1018: REAL;
	...
	(*04x13359*)	F50_P_INST													AT%MW1070: DINT;
	(*04x13361*)	F50_Q_INST													AT%MW1072: DINT;
	(*04x13363*)	F50_S_INST													AT%MW1074: DINT;
	(*04x13365*)	F50_PF_INST													AT%MW1076: INT;
	(*04x13366*)	F50_FHz_INST												AT%MW1077: INT;
	(*04x13367*)	F50_U_Seq_Pos												AT%MW1078: INT;
	(*04x13368*)	F50_U_Seq_Neg												AT%MW1079: INT;
	(*04x13369*)	F50_U_Seq_Zero												AT%MW1080: INT;
	(*04x13370*)	F50_I_Seq_Pos												AT%MW1081: INT;
	(*04x13371*)	F50_I_Seq_Neg												AT%MW1082: INT;
	(*04x13372*)	F50_I_Seq_Zero												AT%MW1083: INT;
	(*04x13373*)	Reserva_13368												AT%MW1084: INT;
	(*04x13374*)	Reserva_13369												AT%MW1085: INT;
	(*04x13375*)	Reserva_13370												AT%MW1086: INT;
	(*04x13376*)	Reserva_13371												AT%MW1087: INT;
	(*04x13377*)	Reserva_13372												AT%MW1088: INT;
	(*04x13378*)	Reserva_13373												AT%MW1089: INT;
	(*04x13379*)	Reserva_13374												AT%MW1090: INT;
	(*04x13380*)	Reserva_13375												AT%MW1091: INT;
	(*04x13381*)	Reserva_13376												AT%MW1092: INT;
	(*04x13382*)	Gerador_Vbarra												AT%MW1093: INT;
	(*04x13383*)	Gerador_ExcitacaoTensao									AT%MW1094 :INT;
	(*04x13384*)	Gerador_ExcitacaoCorrente									AT%MW1095 :INT;

	(*04x13407*)	Gerador_Media_Varm										AT%MW1118: INT;
	(*04x13408*)	Gerador_Media_Iarm											AT%MW1119: INT;

	(*Temperaturas*)
	(*04x13409*) 	MED_750450_AR1_RTD1   									AT%MW1120: REAL;(*FASE A *)
	(*04x13411*)	MED_750450_AR1_RTD2									AT%MW1122: REAL;(*FASE B *)
	(*04x13413*)	MED_750450_AR1_RTD3									AT%MW1124: REAL;(*FASEC *)
	(*04x13415*)	MED_750450_AR1_RTD4 									AT%MW1126: REAL;(*NUCLEO *)
	(*04x13417*)	MED_750450_AR2_RTD1									AT%MW1128: REAL;(*MANCAL VEDAÇÃO LNA *)
	(*04x13419*)	MED_750450_AR2_RTD2									AT%MW1130: REAL;(*MANCAL VEDAÇÃO LA *)
	(*04x13421*)	MED_750450_AR2_RTD3									AT%MW1132: REAL;(*MANCAL TURBINA LNA *)
	(*04x13423*)	MED_750450_AR2_RTD4									AT%MW1134: REAL;(*RESERVA *)
	(*04x13425*)	MED_750450_AR3_RTD1									AT%MW1136: REAL;(*MANCAL ESCORA *)
	(*04x13427*)	MED_750450_AR3_RTD2									AT%MW1138: REAL;(*MANCAL GUIA  LNA - GERADOR *)
	(*04x13429*)	MED_750450_AR3_RTD3									AT%MW1140: REAL;(*CS *)
	(*04x13431*)	MED_750450_AR3_RTD4									AT%MW1142: REAL;(*RESERVA *)
...
setpoints = '''
	...
	(*04x14121*)	Horimetro_UHLM_Ultimo				AT%MW1832: REAL;
       ...
       (* --> Tabela de Leituras Retentivas <-- *)
	(*04x14123*)	Setpoint_HH_Nivel_Barragem 		AT%MW1834: REAL;
	(*04x14125*)	Setpoint_H_Nivel_Barragem			AT%MW1836: REAL;
	(*04x14127*)	Reserva_14127						AT%MW1838: REAL;
	(*04x14129*)	Reserva_14129						AT%MW1840: REAL;
	(*04x14131*)	Reserva_14131						AT%MW1842: REAL;
	(*04x14133*)	Reserva_14133						AT%MW1844: REAL;
	(*04x14135*)	Reserva_14135						AT%MW1846: REAL;
	(*04x14137*)	Reserva_14137						AT%MW1848: REAL;
	(*04x14139*)	Reserva_14139						AT%MW1850: REAL;
	(*04x14141*)	Reserva_14141						AT%MW1852: REAL;
	(*04x14143*)	Reserva_14143						AT%MW1854: REAL;
	(*04x14145*)	Reserva_14145						AT%MW1856: REAL;
'''
